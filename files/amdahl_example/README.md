...
The `amdahl.py` script takes two optional arguments, `--work-seconds` and
`--parallel-proportion`, or the `--help` flag. If no arguments are provided,
the script defaults to 30 seconds of work with a parallel proportion of 80%.
