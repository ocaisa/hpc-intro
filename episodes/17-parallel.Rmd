...
```{r, child=paste(snippets('parallel/one-task.Rmd'), sep=''), eval=TRUE}
```
...
```{r, child=paste(snippets('parallel/four-tasks.Rmd'), sep=''), eval=TRUE}
```
...
```{r, child=paste(snippets('parallel/eight-tasks.Rmd'), sep=''), eval=TRUE}
```
